...
import PermissionBulkCheckRequestItem from './model/PermissionBulkCheckRequestItem';
...
* <pre>
* var PermifyClient = require('index'); // See note below*.
* var xxxSvc = new PermifyClient.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new PermifyClient.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new PermifyClient.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new PermifyClient.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
...
export {
    ...
    /**
     * The BulkCheckBody model constructor.
     * @property {module:model/BulkCheckBody}
     */
    BulkCheckBody,
    ...
    /**
     * The PermissionBulkCheckRequestItem model constructor.
     * @property {module:model/PermissionBulkCheckRequestItem}
     */
    PermissionBulkCheckRequestItem,

    /**
     * The PermissionBulkCheckResponse model constructor.
     * @property {module:model/PermissionBulkCheckResponse}
     */
