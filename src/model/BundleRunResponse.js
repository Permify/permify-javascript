...
class BundleRunResponse {
    /**
     * Constructs a new <code>BundleRunResponse</code>.
     ...
     * @alias module:model/BundleRunResponse
     */
    constructor() { 
        
        BundleRunResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BundleRunResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BundleRunResponse} obj Optional instance to populate.
     * @return {module:model/BundleRunResponse} The populated <code>BundleRunResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BundleRunResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>BundleRunResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BundleRunResponse</code>.
     */
...
export default BundleRunResponse;
