...
class V1Expand {
    /**
     * Constructs a new <code>V1Expand</code>.
     ...
     * @alias module:model/V1Expand
     */
    constructor() { 
        
        V1Expand.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1Expand</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1Expand} obj Optional instance to populate.
     * @return {module:model/V1Expand} The populated <code>V1Expand</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1Expand();
    ...
    /**
     * Validates the JSON data with respect to <code>V1Expand</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>V1Expand</code>.
     */
 ...
 */
V1Expand.prototype['entity'] = undefined;

/**
 * permission is the permission applied to the entity.
 * @member {String} permission
 */
V1Expand.prototype['permission'] = undefined;
 ...
 */
V1Expand.prototype['arguments'] = undefined;

/**
 * @member {module:model/ExpandTreeNode} expand
 */
V1Expand.prototype['expand'] = undefined;

/**
 * @member {module:model/ExpandLeaf} leaf
 */
V1Expand.prototype['leaf'] = undefined;
