...
class Comprehension {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('iterVar2')) {
                obj['iterVar2'] = ApiClient.convertToType(data['iterVar2'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['iterVar2'] && !(typeof data['iterVar2'] === 'string' || data['iterVar2'] instanceof String)) {
            throw new Error("Expected the field `iterVar2` to be a primitive type in the JSON string but got " + data['iterVar2']);
        }
 ...
 * @member {String} iterVar2
 */
Comprehension.prototype['iterVar2'] = undefined;
