...
class DataDeleteResponse {
    /**
     * Constructs a new <code>DataDeleteResponse</code>.
     ...
     * @alias module:model/DataDeleteResponse
     */
    constructor() { 
        
        DataDeleteResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DataDeleteResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DataDeleteResponse} obj Optional instance to populate.
     * @return {module:model/DataDeleteResponse} The populated <code>DataDeleteResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DataDeleteResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DataDeleteResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DataDeleteResponse</code>.
     */
