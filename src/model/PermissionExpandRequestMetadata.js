...
/**
 * The PermissionExpandRequestMetadata model module.
 * @module model/PermissionExpandRequestMetadata
 * @version v0.10.1
 */
class PermissionExpandRequestMetadata {
    ...
    constructor() { 
        ...
        PermissionExpandRequestMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PermissionExpandRequestMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PermissionExpandRequestMetadata} obj Optional instance to populate.
     * @return {module:model/PermissionExpandRequestMetadata} The populated <code>PermissionExpandRequestMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PermissionExpandRequestMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>PermissionExpandRequestMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PermissionExpandRequestMetadata</code>.
     */
...
export default PermissionExpandRequestMetadata;
