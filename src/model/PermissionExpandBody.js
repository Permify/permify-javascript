...
class PermissionExpandBody {
    /**
     * Constructs a new <code>PermissionExpandBody</code>.
     * PermissionExpandRequest is the request message for the Expand method in the Permission service.
     * @alias module:model/PermissionExpandBody
     */
    constructor() { 
        
        PermissionExpandBody.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PermissionExpandBody</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PermissionExpandBody} obj Optional instance to populate.
     * @return {module:model/PermissionExpandBody} The populated <code>PermissionExpandBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PermissionExpandBody();
    ...
    /**
     * Validates the JSON data with respect to <code>PermissionExpandBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PermissionExpandBody</code>.
     */
 ...
 */
PermissionExpandBody.prototype['metadata'] = undefined;

/**
 * @member {module:model/Entity} entity
 */
PermissionExpandBody.prototype['entity'] = undefined;
 ...
 */
PermissionExpandBody.prototype['permission'] = undefined;

/**
 * @member {module:model/Context} context
 */
PermissionExpandBody.prototype['context'] = undefined;

/**
 * Additional arguments associated with this request.
 * @member {Array.<module:model/Argument>} arguments
 */
PermissionExpandBody.prototype['arguments'] = undefined;
...
export default PermissionExpandBody;
