...
export default class SchemaApi {
    ...
    */
     ...
     * @callback module:api/SchemaApi~schemasListCallback
     ...
     * @callback module:api/SchemaApi~schemasPartialWriteCallback
     * @param {String} error Error message, if any.
     ...
     * @callback module:api/SchemaApi~schemasReadCallback
     * @param {String} error Error message, if any.
     ...
     * @callback module:api/SchemaApi~schemasWriteCallback
     * @param {String} error Error message, if any.
