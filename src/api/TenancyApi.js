...
export default class TenancyApi {
    ...
    */
     ...
     * @callback module:api/TenancyApi~tenantsCreateCallback
     ...
     * @param {module:api/TenancyApi~tenantsCreateCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/TenancyApi~tenantsDeleteCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/TenancyApi~tenantsDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/TenancyApi~tenantsListCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/TenancyApi~tenantsListCallback} callback The callback function, accepting three arguments: error, data, response
