...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PermifyApi.V1Call();
  });
  ...
  describe('V1Call', function() {
    it('should create an instance of V1Call', function() {
      // uncomment below and update the code to test V1Call
      //var instance = new PermifyApi.V1Call();
      //expect(instance).to.be.a(PermifyApi.V1Call);
    });
