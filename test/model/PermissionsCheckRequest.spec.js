...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PermifyApi.PermissionsCheckRequest();
  });
  ...
  describe('PermissionsCheckRequest', function() {
    it('should create an instance of PermissionsCheckRequest', function() {
      // uncomment below and update the code to test PermissionsCheckRequest
      //var instance = new PermifyApi.PermissionsCheckRequest();
      //expect(instance).to.be.a(PermifyApi.PermissionsCheckRequest);
    });
