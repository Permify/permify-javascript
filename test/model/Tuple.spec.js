...
(function(root, factory) {
  ...
  describe('Tuple', function() {
    it('should create an instance of Tuple', function() {
      // uncomment below and update the code to test Tuple
      //var instance = new PermifyApi.Tuple();
      //expect(instance).to.be.a(PermifyApi.Tuple);
    });
