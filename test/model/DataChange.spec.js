...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PermifyApi.DataChange();
  });
  ...
  describe('DataChange', function() {
    it('should create an instance of DataChange', function() {
      // uncomment below and update the code to test DataChange
      //var instance = new PermifyApi.DataChange();
      //expect(instance).to.be.a(PermifyApi.DataChange);
    });
    ...
    it('should have the property tuple (base name: "tuple")', function() {
      // uncomment below and update the code to test the property tuple
      //var instance = new PermifyApi.DataChange();
      //expect(instance).to.be();
    });
