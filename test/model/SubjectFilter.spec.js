...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PermifyApi.SubjectFilter();
  });
  ...
  describe('SubjectFilter', function() {
    it('should create an instance of SubjectFilter', function() {
      // uncomment below and update the code to test SubjectFilter
      //var instance = new PermifyApi.SubjectFilter();
      //expect(instance).to.be.a(PermifyApi.SubjectFilter);
    });
