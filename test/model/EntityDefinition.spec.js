...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PermifyApi.EntityDefinition();
  });
  ...
  describe('EntityDefinition', function() {
    it('should create an instance of EntityDefinition', function() {
      // uncomment below and update the code to test EntityDefinition
      //var instance = new PermifyApi.EntityDefinition();
      //expect(instance).to.be.a(PermifyApi.EntityDefinition);
    });
