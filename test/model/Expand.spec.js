...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PermifyApi.Expand();
  });
  ...
  describe('Expand', function() {
    it('should create an instance of Expand', function() {
      // uncomment below and update the code to test Expand
      //var instance = new PermifyApi.Expand();
      //expect(instance).to.be.a(PermifyApi.Expand);
    });
