...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PermifyApi.RuleDefinition();
  });
  ...
  describe('RuleDefinition', function() {
    it('should create an instance of RuleDefinition', function() {
      // uncomment below and update the code to test RuleDefinition
      //var instance = new PermifyApi.RuleDefinition();
      //expect(instance).to.be.a(PermifyApi.RuleDefinition);
    });
