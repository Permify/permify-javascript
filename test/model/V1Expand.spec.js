...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PermifyApi.V1Expand();
  });
  ...
  describe('V1Expand', function() {
    it('should create an instance of V1Expand', function() {
      // uncomment below and update the code to test V1Expand
      //var instance = new PermifyApi.V1Expand();
      //expect(instance).to.be.a(PermifyApi.V1Expand);
    });
