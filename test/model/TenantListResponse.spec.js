...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PermifyApi.TenantListResponse();
  });
  ...
  describe('TenantListResponse', function() {
    it('should create an instance of TenantListResponse', function() {
      // uncomment below and update the code to test TenantListResponse
      //var instance = new PermifyApi.TenantListResponse();
      //expect(instance).to.be.a(PermifyApi.TenantListResponse);
    });
