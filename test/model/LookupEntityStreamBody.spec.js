...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PermifyApi.LookupEntityStreamBody();
  });
  ...
  describe('LookupEntityStreamBody', function() {
    it('should create an instance of LookupEntityStreamBody', function() {
      // uncomment below and update the code to test LookupEntityStreamBody
      //var instance = new PermifyApi.LookupEntityStreamBody();
      //expect(instance).to.be.a(PermifyApi.LookupEntityStreamBody);
    });
