...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PermifyApi.CheckBody();
  });
  ...
  describe('CheckBody', function() {
    it('should create an instance of CheckBody', function() {
      // uncomment below and update the code to test CheckBody
      //var instance = new PermifyApi.CheckBody();
      //expect(instance).to.be.a(PermifyApi.CheckBody);
    });
