...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PermifyApi.LookupEntityBody();
  });
  ...
  describe('LookupEntityBody', function() {
    it('should create an instance of LookupEntityBody', function() {
      // uncomment below and update the code to test LookupEntityBody
      //var instance = new PermifyApi.LookupEntityBody();
      //expect(instance).to.be.a(PermifyApi.LookupEntityBody);
    });
