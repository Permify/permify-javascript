...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PermifyApi.PermissionExpandBody();
  });
  ...
  describe('PermissionExpandBody', function() {
    it('should create an instance of PermissionExpandBody', function() {
      // uncomment below and update the code to test PermissionExpandBody
      //var instance = new PermifyApi.PermissionExpandBody();
      //expect(instance).to.be.a(PermifyApi.PermissionExpandBody);
    });
