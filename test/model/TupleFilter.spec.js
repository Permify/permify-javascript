...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PermifyApi.TupleFilter();
  });
  ...
  describe('TupleFilter', function() {
    it('should create an instance of TupleFilter', function() {
      // uncomment below and update the code to test TupleFilter
      //var instance = new PermifyApi.TupleFilter();
      //expect(instance).to.be.a(PermifyApi.TupleFilter);
    });
