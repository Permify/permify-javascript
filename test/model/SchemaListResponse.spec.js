...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PermifyApi.SchemaListResponse();
  });
  ...
  describe('SchemaListResponse', function() {
    it('should create an instance of SchemaListResponse', function() {
      // uncomment below and update the code to test SchemaListResponse
      //var instance = new PermifyApi.SchemaListResponse();
      //expect(instance).to.be.a(PermifyApi.SchemaListResponse);
    });
