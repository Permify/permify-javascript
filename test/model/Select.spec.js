...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PermifyApi.Select();
  });
  ...
  describe('Select', function() {
    it('should create an instance of Select', function() {
      ...
      //var instance = new PermifyApi.Select();
      //expect(instance).to.be.a(PermifyApi.Select);
    });
    ...
    it('should have the property testOnly (base name: "testOnly")', function() {
      // uncomment below and update the code to test the property testOnly
      //var instance = new PermifyApi.Select();
      //expect(instance).to.be();
    });
