...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PermifyApi.Subjects();
  });
  ...
  describe('Subjects', function() {
    it('should create an instance of Subjects', function() {
      // uncomment below and update the code to test Subjects
      //var instance = new PermifyApi.Subjects();
      //expect(instance).to.be.a(PermifyApi.Subjects);
    });
